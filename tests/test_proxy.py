...
class ProxyTest(unittest.TestCase):
    ...
    @patch('proxy.run_geminicli', new_callable=AsyncMock)
    ...
    def test_run_geminicli_called(self, mock_create):
        ...
        from proxy import run_geminicli
        import asyncio
        out = asyncio.run(run_geminicli('hello'))
